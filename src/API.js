...
const TMDB_API_KEY = "58c81d8f2942eabdc665e3a86dc13ede"; // Your API key as a string

const API_BASE_URL = "https://api.themoviedb.org";
const TRENDING_BASE_URL = `${API_BASE_URL}/3/trending/all/day?api_key=${TMDB_API_KEY}`;
const SEARCH_BASE_URL = `${API_BASE_URL}/3/search/multi?api_key=${TMDB_API_KEY}&language=en-US`;
